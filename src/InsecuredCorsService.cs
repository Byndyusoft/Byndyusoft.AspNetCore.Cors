...
namespace Byndyusoft.AspNetCore.Cors
{
    ...
    {
        private MethodInfo _isOriginAllowedMethod;
        ...
        private CorsResult EvaluatePolicyInsecure(HttpContext context, CorsPolicy policy)
       {
        ...
        {
            _isOriginAllowedMethod ??= typeof(CorsService).GetMethod(nameof(IsOriginAllowed), BindingFlags.Instance | BindingFlags.NonPublic);
            return (bool)_isOriginAllowedMethod!.Invoke(this, new object[]{policy, origin})!;
        }
    }
}